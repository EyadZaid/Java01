...
class QueriesTest {
    ...
    void searchThreeMoviesByImdbIdTest() {
        ...
        Movie movie1 = queryManager.searchById(idToSearch1);
        assertEquals(idToSearch1, movie1.getImdbID());

        String idToSearch2 = "tt0220264";
        Movie movie2 = queryManager.searchById(idToSearch2);
        assertEquals(idToSearch2, movie2.getImdbID());

        String idToSearch3 = "tt0412142";
        Movie movie3 = queryManager.searchById(idToSearch3);
    ...
    void searchThreeMoviesByTitleTest() {
        String title = "soul";
        List<Movie> movies = queryManager.searchByTitle(title);

        assertEquals(10, movies.size());

        String idToSearch = "tt2948372";
        Movie mov = queryManager.searchById(idToSearch);

        assertTrue(movies.contains(mov));


        String title2 = "the russia house";
        List<Movie> movies2 = queryManager.searchByTitle(title2);

        assertEquals(1, movies2.size());

        String idToSearch2 = "tt0100530";
        Movie mov2 = queryManager.searchById(idToSearch2);

        assertTrue(movies2.contains(mov2));


        String title3 = "Russia";
        List<Movie> movies3 = queryManager.searchByTitle(title3);

        assertEquals(10, movies3.size());

        String idToSearch3 = "tt0057076";
        Movie mov3 = queryManager.searchById(idToSearch3);
